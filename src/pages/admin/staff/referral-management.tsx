...
const ReferralManagement = () => {
    ...
    return (
        // ROOT: Thêm text-white, overflow-hidden để fix layout
        <div className="flex h-screen w-full overflow-hidden font-sans relative text-sm text-white">
            ...
            {/* 2. VÙNG NỘI DUNG CHÍNH (Glass) */}
            <div className="flex flex-col flex-1 min-w-0 h-full overflow-hidden relative z-10 scrollbar-hide">
