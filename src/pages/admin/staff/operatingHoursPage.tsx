...
export default function OperatingHoursPage() {
    ...
    return (
        ...
        <div className="flex h-screen w-full overflow-hidden font-sans text-white">
            ...
            <main className="flex-1 flex flex-col min-w-0 h-full relative z-10 scrollbar-hide">
                {/* Header (Transparent) */}
                <header className="bg-transparent border-b border-white/10 px-6 py-4 flex items-center justify-between flex-shrink-0 z-10 backdrop-blur-sm">
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar">
                    <div className="w-full h-full flex flex-col gap-6">
                        ...
                        <div className="bg-white/5 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/10 flex flex-col h-full md:h-auto overflow-hidden">
